...
export const Avatar = ({imageUrl, name, big, reverse, onClick, loading}: AvatarParams) => {
    const nameDiv =
        ...
        <div className={styles.avatar} onClick={onClick}>
            ...
            {loading ?
                <Skeleton circle={true}
                          className={`${styles.avatarImage} ${big && styles.avatarImageBig}`}
                          containerClassName={`${styles.avatarImage} ${big && styles.avatarImageBig}`}
                /> :
